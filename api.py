...
def predict():
    ...
    predictor = pickle.load(open(os.path.join(MODEL_DIR, "model_xgb.pkl"), "rb"))
    scaler = pickle.load(open(os.path.join(MODEL_DIR, "scaler.pkl"), "rb"))
    cv = pickle.load(open(os.path.join(MODEL_DIR, "countVectorizer.pkl"), "rb"))
    ...
    try:
        ...
        import traceback
        traceback.print_exc()  # This will print full error to terminal
